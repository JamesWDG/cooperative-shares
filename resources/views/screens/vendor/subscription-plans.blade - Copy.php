...
@push('styles')
    ...
    <style>
        /* Ensure modal backdrop and stripe modal proper z-index pe hon */
        .modal-backdrop {
        ...
        #stripePaymentModal label.control-label,
        #stripePaymentModal .form-label {
            font-weight: 500;
            font-size: 14px;
            margin-bottom: 4px;
        }
        ...
        #stripePaymentModal .error .alert {
            padding: 8px 12px;
            font-size: 13px;
            border-radius: 6px;
            margin-top: 8px;
            ...
            <div class="modal-body">
                <form
                    ...
                    <div class="mb-3 required">
                        ...
                        <p class="mb-1">
                            <strong id="stripe_plan_name_text">—</strong>
                        </p>
                    </div>
                    ...
                    <div class="mt-3">
                        <button class="btn btn-primary w-100" type="submit" id="stripe-submit-btn">
                            Pay &amp; Subscribe
                        </button>
                    </div>
