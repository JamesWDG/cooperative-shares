...
@section('section')
    <section class="main-content-area">
        <div class="heading-wrapper">
            <h1 class="dashboard-hd">Co-Op List</h1>
            <a href="{{ route('vendor.blog.create') }}" class="add-btn">
        ...
        <div class="table-container">
            <table id="blogs-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center">No Co-Op Found!</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
@push('scripts')
    {{-- DataTables JS (ensure jQuery is loaded in your main layout before this) --}}
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.delete-blog', function () {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "This Co-Op will be deleted permanently.",
                    icon: 'warning',
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            if (res.status) {
                                showToastjQuery("Deleted", res.msg || "Co-Op deleted successfully.", "success");
                                ...
                                showToastjQuery("Error", res.msg || "Unable to delete Co-Op.", "error");
                            }
                        },
                        error: function () {
                            $.LoadingOverlay("hide");
