...
<section class="main-content-area">
    <h2 class="dashboard-hd">Add New Co-Op</h2>

    <div class="propFormContainer">
        <form action="{{ route('vendor.blog.store') }}"
              method="POST"
            ...
            <div class="propFormGroup">
                ...
                <input type="number" name="read_in_minutes" class="propInput" min="1" placeholder="e.g. 5">
            </div>
...
@include('includes.admin.form-scripts',[
    'redirect_url' => route('vendor.blogs')
])
<script>
