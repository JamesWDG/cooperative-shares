...
<section class="main-content-area">
    <h2 class="dashboard-hd">Edit Training Video</h2>

    <div class="propFormContainer">
        <form action="{{ route('admin.training-video.update', $video->id) }}"
              method="POST"
            ...
            <div class="propFormGroup">
                ...
                <input type="text" name="name" class="propInput" value="{{ $video->name }}">
            </div>

            <div class="propFormGroup">
                <label class="propLabel">Upload Video</label>
                <input type="file" name="video" class="propInput" id="video-file">
                @if($video->video)
                    <video id="videoPreview" class="preview-video" controls style="display: block;">
            ...
            <button type="button"
                    ...
                    data-original-text="Update Video">
                Update Video
            </button>
        </form>
    </div>
