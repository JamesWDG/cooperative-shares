            ...
            <div class="dropdown admin-notify-dropdown">
                <button class="btn dropdown-toggle position-relative" type="button" data-bs-toggle="dropdown"
                    ...
                    @if($vendornotifications->count())
                        <span class="badge">{{ $vendornotifications->count() }}</span>
                    @endif
                </button>
                ...
                <ul class="dropdown-menu notify-dropdown">
                    ...
                    <li class="d-flex justify-content-between px-3 py-2 border-bottom">
                        <p class="mb-0">
                            <span>{{ $vendornotifications->count() }}</span> Unread Messages
                        </p>
                    ...
                    @forelse($vendornotifications as $note)
                        <li class="notify-li">
                            <a href="{{ route('vendor.notifications.view', $note->slug) }}" class="d-flex align-items-start gap-2">
