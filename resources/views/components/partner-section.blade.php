            ...
            <div class="main-logo-area">
                <div class="border-div">
                    <div class="row">
                        ...
                        @php
                            $logo = $frontPageFooterSponsorSlot?->vendor?->profile_logo != null ? asset($frontPageFooterSponsorSlot?->vendor?->profile_logo) : asset('assets/web/images/pmc1.png');
                            $uniqueCitiesCount = $frontPageFooterSponsorSlot?->vendor?->listings?->pluck('city')->map(fn($city) => strtolower($city))->unique()->count();
                        @endphp
                            ...
                            @if($frontPageAdCount)
                                @for($i = 1 ; $i <= $frontPageAdCount ; $i++)
                                    <div class="col-lg-4 border-class px-0 remove-border advertise-class"> 
                                        <a href="#">
                                            <div title="Mac Properties" class="mortar-card tier2 interactive sharpCorner remove-border">
                                                <img src="{{ asset('assets/web/images/pmc6.png') }}" alt="" class="img-fluid pmc-img">
                                            </div>
